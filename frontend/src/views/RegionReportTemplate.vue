<template>
  <div class="p-4">
    ...
    <div class="overflow-x-auto template-table overflow-y-auto border border-gray-300 rounded mb-4">
  ...
  <div v-if="selectedTemplate"
    ...
    <div class="bg-white p-6 rounded shadow-lg max-w-2xl w-full">
      ...
      <div class="whitespace-pre-wrap text-sm text-gray-800 max-h-[400px] overflow-y-auto"
           v-text="selectedTemplate?.content"></div>
...
.template-table { max-height: 500px; }
.overflow-y-auto {
  overflow-y: auto;
}
