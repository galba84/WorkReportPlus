...
@Service
public class AppSettingsService implements org.springframework.boot.ApplicationRunner {
    @Override public void run(org.springframework.boot.ApplicationArguments args) {
        regionTo100_30_Map.clear();
        findByKey(ATTENDANCE_MAP).ifPresent(this::refreshIfRequired);
    }
