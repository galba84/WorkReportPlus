...
public class UserServiceImpl implements UserService {
    ...
    public UserDto addOrUpdateUser(UserDto userDto) {
        if (!java.util.Set.of("ADMIN", "POWER_USER", "USER", "GUEST").contains(userDto.getRole() == null ? "" : userDto.getRole())) {
            throw new IllegalArgumentException("Invalid role");
        }
        if (userDto.getPassword() != null && !userDto.getPassword().isBlank()) validatePassword(userDto.getPassword());
